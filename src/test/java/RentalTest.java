...
public class RentalTest {
    ...
    @Test
    void test_getRentalId(){
        assertEquals(rentalId, testRental.getRentalId(), "returns rental id.");
    }
    @Test
    ...
    @Test
    void test_setRentalId(){
        int expected = 50;
        testRental.setRentalId(expected);
        assertEquals(expected, testRental.getRentalId(), "set rental id.");
    }
    @Test
